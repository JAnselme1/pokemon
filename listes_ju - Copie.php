...
<a href="index.php"><img src='img/retour.jpg' alt=retour width=50em></a><table id=tableLegende>
	<tr>
		<td class="legende">liste de nos cartes : </td> 
		...
		<td style='background-color: palegreen'>doubles</td>
			<td><img style='float: right;padding-right: 0.5em' src='./img/logo_reverse.png'>Reverse(Collection)</td>
			<td style='background-color: palegreen'>Reverse(Doubles): <span style='color: RoyalBlue;font-weight: bold'>R</span></td></tr> </td>
	</tr>
</thead>
<tbody>
<?php
